## openSpeaQC
* ein Erweiterungspaket für Verleihbetriebe zum ganzheitlichen Messen von aktiven und passiven Lautsprechersystemen.* 

Die openSpeaQC-Applikation soll die von dramsay9 zur Verfügung gestellten Messwerkzeuge um einige Tools erweitern.
Innerhalb von audioSample, audioExtras und AudioMeasure wurden zahlreiche Modifikationen und Erweiterungen eingefügt,
während eigene Module in die Repo mit aufgenommen wurden.

Zum jetzigen Zeitpunkt gibt es kein ganzheitliches Skript, das die einzelnen Prozesse nacheinander durchläuft.
Das soll sich jedoch als nächsten Schritt der Entwicklung ändern.

Auch die Auskommentierung der einzelnen Module soll stetig folgen.
